...
int main()
{
    ...
    auto _cubeTexture = _skybox->getCubeTexture();

    engine::LShaderManager::INSTANCE->currentShader = engine::LShaderManager::INSTANCE->programs["basic3d_env_mapping_reflection"];
    ...
    while ( _window.isActive() )
    {
        ...
        GLuint _uniformViewPos = glGetUniformLocation( _shader, "u_viewPos" );
        ...
        glUniform3f( _uniformViewPos, _cpos.x, _cpos.y, _cpos.z );
