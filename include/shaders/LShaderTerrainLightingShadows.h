...
namespace engine
{
    ...
    class LShaderTerrainLightingShadows : public LShaderBasic3d
    {
        ...
        LShaderTerrainLightingShadows( GLuint id ) : LShaderBasic3d( id )
        {
            bind();
            ...
            m_uTexture = glGetUniformLocation( m_id, "u_texture" );
